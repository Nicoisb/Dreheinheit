...
(function (root, factory) {
	...
	function PureKnob() {
		 ...
		 */
		this.createKnob = function(width, height, name) {
			const heightString = height.toString();
			const widthString = width.toString();
			...
			inputName.value = nameString;
			input.setAttributeNode(inputName);
			const inputId = document.createAttribute('id');
			inputId.value = 'input_' + nameString;
			...
			const inputMode = document.createAttribute('type');
			inputMode.value = 'number';
